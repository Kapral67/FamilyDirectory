...
class Tutorial04 {
    ...
    void main (final String[] args) {
        ...
        try {
            ...
            should be.
             */
            final Panel contentPanel = new Panel(new GridLayout(2));
             ...
             */
            final GridLayout gridLayout = (GridLayout) contentPanel.getLayoutManager();
             ...
             */
            final Label title = new Label("This is a label that spans two columns");
            title.setLayoutData(GridLayout.createLayoutData(GridLayout.Alignment.BEGINNING, // Horizontal alignment in the grid cell if the cell is larger than the component's preferred size
            ...
            final List<String> timezonesAsStrings = new ArrayList<>(Arrays.asList(TimeZone.getAvailableIDs()));
            final ComboBox<String> readOnlyComboBox = new ComboBox<>(timezonesAsStrings);
            ...
            contentPanel.addComponent(new ComboBox<>("Item #1", "Item #2", "Item #3", "Item #4").setReadOnly(false)
            ...
            contentPanel.addComponent(new Button("Button", () -> MessageDialog.showMessageDialog(textGUI, "MessageBox", "This is a message box", MessageDialogButton.OK)).setLayoutData(
            ...
            final int cols = (screen.getTerminalSize()
                                    .getColumns() - window.getPreferredSize()
                                                          .getColumns()) / 2;
            final int rows = (screen.getTerminalSize()
                                    .getRows() - window.getPreferredSize()
                                                       .getRows()) / 2;

            window.setPosition(new TerminalPosition(cols, rows));
